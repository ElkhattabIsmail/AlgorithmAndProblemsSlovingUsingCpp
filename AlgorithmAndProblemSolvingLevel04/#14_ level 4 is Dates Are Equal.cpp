...
bool IsDate1LessThanDate2(str_Date Date1, str_Date Date2)
{
	return (Date1.Year < Date2.Year) ? true :
		((Date1.Year == Date2.Year) ? (Date1.Month < Date2.Month ? true :
			(Date1.Month == Date2.Month ? Date1.Day < Date2.Day : false)) : false);
}
bool IsDatesAreEquals(str_Date Date1, str_Date Date2)
{
...
int main() {
	...
	str_Date Date1 = ReadFullDate();

	str_Date Date2 = ReadFullDate();


	if (IsDatesAreEquals(Date1, Date2))
		cout << "\nDate1 And Date2 Are Equals";
	else
		cout << "\nDate1 And Date2 Not Equals";
