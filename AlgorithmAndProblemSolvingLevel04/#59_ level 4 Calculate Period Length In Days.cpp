...
short PeriodeLength(stPeriod Period1, bool IncludeEndDate = false)
{
...
int main()
{
	...
	cout << "\nPeriod Length : " << PeriodeLength(Period1) << endl;
	cout << "\nPeriod Length(Including End Date) : " << PeriodeLength(Period1,true) << endl;
